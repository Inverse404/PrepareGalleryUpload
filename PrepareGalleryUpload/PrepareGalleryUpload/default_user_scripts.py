...
def generate_web_files( source_file_path, configuration ):
	...
	output_file_name			= pgu_util.construct_output_web_file_name( source_file_path, output_directory )
	...
	create_thumbnail( source_file_path, output_path_thumb, configuration )
