...
arguments_parser.add_argument('source-directory')
...
if os.path.isdir( command_line_arguments.source-directory ) == False:
	print( "ERROR: Source directory not found!")
	exit(2)

ffmpeg_path = default_ffmpeg_path
source_dir_path		= command_line_arguments.source-directory
...
for dir_entry in os.scandir( command_line_arguments.source-directory ):
	...
	if entry_extension.lower() == ".mp4":
		...
		envira_gallery_import_file = open( evira_gallery_import_file_path, 'w' )
